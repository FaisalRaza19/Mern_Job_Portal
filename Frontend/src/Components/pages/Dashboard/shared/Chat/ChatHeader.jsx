        ...
        <div className="relative">
          ...
          {showMenu && (
            <div className="absolute right-0 top-full mt-2 w-48 bg-white  rounded-lg shadow-lg border border-gray-200 py-2 z-50">
              <button className="flex items-center space-x-3 w-full px-4 py-2 text-gray-700 hover:bg-gray-100 transition-colors text-left">
                <FiInfo className="w-4 h-4" />
                <span>Contact info</span>
              </button>
              <button className="flex items-center space-x-3 w-full px-4 py-2 text-gray-700 not-first:hover:bg-gray-100 transition-colors text-left">
