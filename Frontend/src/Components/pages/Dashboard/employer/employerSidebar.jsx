...
import {
  FiHome, FiPlus, FiBriefcase, FiUsers, FiMessageCircle, FiSettings, FiChevronLeft, FiChevronRight, FiFileText,
} from "react-icons/fi"
...
const menuItems = [
  ...
  { id: "post-job", label: "Post Job", icon: FiPlus },
...
const EmployerSidebar = ({ activeTab, onTabChange, isCollapsed, onToggleCollapse }) => {
  return (
    <div
    ...
    >
      <div className="p-4 border-b border-gray-200">
        <div className="flex items-center justify-between">
          ...
          {!isCollapsed && <h2 className="text-lg font-semibold text-gray-900">Employer</h2>}
          <button
