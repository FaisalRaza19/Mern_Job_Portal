...
const CurrencyDropdown = ({ value, onChange })=>{
  ...
  return (
    <div className="relative w-full" ref={dropdownRef}>
      {/* Selected value */}
      <div
        className="border border-gray-300 bg-white text-gray-900 px-3 py-2 rounded-lg cursor-pointer"
      ...
      {/* Dropdown */}
      {isOpen && (
        <ul className="absolute z-10 w-full mt-1 max-h-60 overflow-auto border border-gray-300 bg-white rounded-lg shadow-lg">
          <input
            autoFocus
            type="text"
            className="w-full px-3 py-2 bg-white text-gray-900 border-b border-gray-200 focus:outline-none"
