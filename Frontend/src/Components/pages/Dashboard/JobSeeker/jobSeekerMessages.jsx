...
const mockMessages = {
  "1": [
    {
      id: "1",
      text: "Hello! Thank you for applying to the Frontend Developer position at TechCorp.",
      sender: "employer",
      timestamp: "10:30 AM",
    },
    {
    ...
    {
      id: "3",
      text: "Great! We were impressed with your portfolio. Would you be available for a video interview next week?",
      sender: "employer",
      timestamp: "11:00 AM",
    },
    {
  ...
  "2": [
    {
      id: "1",
      text: "Hi there! We received your application for the UI/UX Designer role.",
      sender: "employer",
      timestamp: "Yesterday 2:30 PM",
    },
    {
      id: "2",
      text: "Hello! Thank you for reaching out. I'm very interested in the position.",
      sender: "user",
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex justify-between items-start">
                          <div>
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400 truncate">{conversation.jobTitle}</p>
                          </div>
                          {conversation.unread && (
              ...
              <>
                ...
                <div className="flex items-center space-x-3 pb-4 border-b border-gray-200 dark:border-gray-700">
                  <img
                    ...
                    alt={selectedConv.employerName}
                    className="w-10 h-10 rounded-full"
                  />
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-white">{selectedConv.employerName}</h3>
                    <p className="text-sm text-blue-600 dark:text-blue-400">
                      {selectedConv.companyName} • {selectedConv.jobTitle}
                    </p>
                  </div>
                </div>
