        ...
        <div className="rounded-xl bg-white p-6 shadow-sm">
            <div className="mb-4 flex items-center justify-between">
                ...
                <select
                    ...
                    className="rounded-md border border-gray-300 py-2 pr-8 text-gray-900 shadow-sm focus:border-gray-500 focus:ring-gray-500"
                >
            ...
            <div className="mt-6 flex justify-center space-x-4">
                {displayCount < sortedReviews.length && (
                    <button
                        ...
                        disabled={isLoading}
                        className="inline-flex items-center rounded-md bg-gray-900 px-4 py-2 text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500"
                    >
                        {isLoading ? (
                            <>
