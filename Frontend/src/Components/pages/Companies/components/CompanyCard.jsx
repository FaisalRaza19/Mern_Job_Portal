  ...
  return (
    ...
    >
      <div className="flex items-center space-x-4">
        <img
          src={company.logo || "/placeholder.svg?height=64&width=64&query=company%20logo"}
        ...
        <div className="flex-1">
          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-50">{company.name}</h3>
